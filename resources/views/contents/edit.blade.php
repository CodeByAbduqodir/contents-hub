        ...
        <form action="{{ route('contents.update', $content->id) }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title', $content->title) }}">
                </div>

                <div class="col-md-6">
                    <label for="description" class="form-label">Description:</label>
                    <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror">{{ old('description', $content->description) }}</textarea>
                </div>

                <div class="col-md-6">
                    <label for="url" class="form-label">URL (optional):</label>
                    <input type="url" name="url" id="url" class="form-control @error('url') is-invalid @enderror" value="{{ old('url', $content->url) }}">
                </div>
